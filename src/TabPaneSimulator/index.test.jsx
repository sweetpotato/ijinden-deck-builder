...
test('デッキ10枚でスタート、リセット', async () => {
  ...
  // ガーディアン4枚で不可視
  const groupGuardians = getByRole('region', { name: 'ガーディアン' })
  ...
  // 手札6枚で可視
  const groupHand = getByRole('region', { name: '手札' })
...
test('デッキ10枚でスタート、マリガン、リセット', async () => {
  ...
  // ガーディアン4枚で不可視
  let groupGuardians = getByRole('region', { name: 'ガーディアン' })
  expect(groupGuardians).toBeVisible()
  ...
  expect(guardians[3]).toHaveClass('btn-toggled-opaque')
  // 手札6枚で可視
  let groupHand = getByRole('region', { name: '手札' })
  expect(groupHand).toBeVisible()
  ...
  // ガーディアン4枚で不可視
  groupGuardians = getByRole('region', { name: 'ガーディアン' })
  expect(groupGuardians).toBeVisible()
  ...
  expect(guardians[3]).toHaveClass('btn-toggled-opaque')
  // 手札6枚で可視
  groupHand = getByRole('region', { name: '手札' })
  expect(groupHand).toBeVisible()
