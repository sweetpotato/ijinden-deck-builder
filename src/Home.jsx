    ...
    <>
      ...
      >
        ...
        <Tab eventKey={enumTabPane.HELP} title="ヘルプ" className="mx-2 mt-2">
          ...
          <h3>カードタブ</h3>
          <p>
            各カードのプラス・マイナスボタンでメインデッキ・サイドデッキ別々に枚数を増減できます。カード名やルールテキストを入力してカードの検索βができます。「さらに絞り込む」を開くとエキスパンション、色、種類、レベル、特性、能力語、遺業能力でカードの絞り込みができます。
          </p>
          <Alert variant="info">
          ...
          <Alert variant="info">
            検索はルールテキスト全体を探します。例えば「執筆」で検索すると《清少納言》など執筆能力を持つカードだけでなく《始皇帝》などもヒットします。前者のみヒットさせたい場合は検索ではなく「さらに絞り込む」の能力語を使用ください。特性や遺業能力も同様です。
          </Alert>
          <h3>レシピタブ</h3>
          <p>
            カードの左下をタップする
          ...
          <h4>テキストデータをコピーβ</h4>
          <p>
            レシピタブの下方にある「▼テキストデータをコピーβ」ボタンで、デッキレシピのテキストデータをクリップボードにコピーできます。Excel
            や Google
