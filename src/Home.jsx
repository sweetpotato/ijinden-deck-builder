    ...
    <>
      ...
      >
        ...
        <Tab eventKey={enumTabPane.HELP} title="ヘルプ" className="mx-2 mt-2">
          <h2>これは何？</h2>
          <p>
            イジンデンのデッキレシピを作成するアプリです。登録不要でどなたでも使えます。画像のダウンロードを除き、アプリの実行やデータの保存はお使いのスマホやパソコンの中で完結します。
          </p>
          <p>
          ...
          <h3>カードタブ</h3>
          <p>
            各カードのプラス・マイナスボタンでメインデッキ・サイドデッキ別々に枚数を増減できます。カード名、ルールテキスト、イラストレータ名を入力してカードの検索ができます。「条件で絞り込む」を開くとエキスパンション、レアリティ、色、種類、レベル、特性、能力語、遺業能力でカードの絞り込みができます。
          </p>
          <Alert variant="info">
          ...
          <Alert variant="info">
            検索はイラストレータ名も探します。英大小文字の区別はなく、部分一致でもヒットします。ただし「é」などアクセント符号付きの文字は符号なしの「e」ではヒットしません。また、日本語名の場合は読み仮名ではヒットせず、同一人物の別名義にも文字が一致していなければヒットしません。
          </Alert>
          <Alert variant="info">
            一部カードの印刷の抜けや誤りについては次のように扱います。絞り込みやテキスト検索の際はご注意ください。
            <ul>
              <li>
                オブシディアンのレアリティは「N」ではなく「R」として扱います。
              </li>
              <li>
                第4弾の一部カードのイラストレーター表記「タカハシユウ」は「高橋祐」として扱います。
              </li>
              <li>
                第5弾の一部カードで「勝鬨」が抜けているものは表記があるものとして扱います。
              </li>
              <li>第6弾の「本田正信」は「本多正信」として扱います。</li>
            </ul>
          </Alert>
          <h3>レシピタブ</h3>
          <p>
          ...
          <h4>レシピ画像をダウンロード</h4>
          <p>
            レシピタブの下方にある「レシピ画像をダウンロード」ボタンで、編集中のデッキレシピを画像としてダウンロードできます。
          </p>
          <h4>共有リンクをコピー</h4>
          <p>
