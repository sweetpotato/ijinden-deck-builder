    ...
    <>
      ...
      >
        ...
        <Tab eventKey={enumTabPane.HELP} title="ヘルプ" className="mx-2 mt-2">
          ...
          <h3>カード</h3>
          <p>
            各カードのプラス・マイナスボタンで、メインデッキ・サイドデッキ別々に枚数を増減できます。エキスパンション、色、種類、能力語でカードの絞り込みができます。
          </p>
          <h3>レシピ</h3>
          <p>
            カードの左下をタップする
          ...
          <p>
            スタートボタンを押した直後は対戦開始前の状態です。1回だけマリガン
            (引き直す)
            ボタンで手札を引き直せます。リセットボタンでやり直します。
          </p>
          <p>
            プラスボタンで山札からカードを引きます。手札のカードはタップ
            (PCではクリック) するたびに通常→赤→青→黄→白→黒→通常と色味が変わります。
          </p>
          <p>
            灰色のガーディアンはタップ (PCではクリック)
            するとオモテ面のカード画像が表示されます。その後は手札と同じようにタップで色味が変わります。
          </p>
          <h2>未対応機能</h2>
          <h3>自前の画像保存</h3>
